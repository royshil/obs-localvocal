...
set(PREBUILT_WHISPERCPP_VERSION "0.0.9-1")
...
if(APPLE)
  ...
  if($ENV{MACOS_ARCH} STREQUAL "x86_64")
    set(WHISPER_CPP_HASH "7fcf4c2c79e7d0c727dca8652182625d052f8b0612c307675a6602fb70960e63")
  elseif($ENV{MACOS_ARCH} STREQUAL "arm64")
    set(WHISPER_CPP_HASH "10faf36d77f409b3d85e3478062b14e5ad82b27ef22b3ed57d65bfd756214dbd")
  else()
    message(
      FATAL_ERROR
...
elseif(WIN32)
  ...
  if(${ACCELERATION} STREQUAL "cpu")
    set(WHISPER_CPP_HASH "f9a1218414968f704a84fdd62b13ab8766c17567577742f166e3d96344b483cb")
  elseif(${ACCELERATION} STREQUAL "dynamic-cpu")
    set(WHISPER_CPP_HASH "852492af4d121c25e93567ab9295cf2a5acd8b5a34b4c9c1dc0729376d9ff18e")
  elseif(${ACCELERATION} STREQUAL "cuda")
    set(WHISPER_CPP_HASH "7955f1934a9b42efdb7dbc48f7880e947ba26ceb5ea10afe43e2f4ad82874d6b")
    list(APPEND WHISPER_LIBRARIES GGMLCUDA)
  elseif(${ACCELERATION} STREQUAL "hipblas")
    set(WHISPER_CPP_HASH "031afcbe03c5ba54d936553944d770dfbe8688f2491031b7c79a57d44d056ae7")
    list(APPEND WHISPER_LIBRARIES GGMLHip)
  elseif(${ACCELERATION} STREQUAL "vulkan")
    set(WHISPER_CPP_HASH "de208d6aaa70c37fba8ead1ac7b64552b07e67e240fde9ea82c507c5c7e2d220")
  ...
  set(WHISPER_LIBRARIES Whisper GGML GGMLBase GGMLBlas)
  ...
  if(WHISPER_DYNAMIC_BACKENDS)
    ...
    list(APPEND WHISPER_LIBRARIES GGMLCPU)
  endif()
